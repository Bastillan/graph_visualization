...
float sub(float arg1, float arg2) { return arg1 - arg2; }

float mul(float arg1, float arg2) { return arg1 * arg2; }

float divide(float arg1, float arg2) { return arg1 / arg2; }

float y(float x, float a, float b) {
    boost::dll::fs::path plugin_path = "../cpp/app/plugins/libplugin.so";

    boost::dll::shared_library lib(
        plugin_path); // argv[1] contains path to directory with our plugin
                      // library
